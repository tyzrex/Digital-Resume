    ...
    <div className=" w-full  px-4 pt-8 max-w-6xl mx-auto">
      <div className="grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 gap-5 grid-flow-row-dense">
        <motion.div
          ...
          dragElastic={1}
          className="border cursor-pointer z-20 dark:border-neutral-600 border-neutral-400/60 overflow-hidden relative shadow-xl rounded-lg sm:h-48"
        >
          <div className="absolute w-full p-2 z-10">
            <div className="flex justify-between items-center ">
              <p className="text-xs">Location</p>
              <p className="text-neutral-500 text-xs ">Kathmandu</p>
            </div>
            <div className="w-full h-[0.9px] dark:bg-neutral-600 bg-neutral-400/60 mt-1 top-7  " />
          </div>
          <motion.img
            whileHover={{ scale: 1.1 }}
            className="h-full w-full duration-300 transition-all ease-in-out object-contain pt-10 pl-2 pb-5"
            src={theme == "dark" ? "/nepal.png" : "/nepal.png"}
            alt=""
          />
        </motion.div>
        <div className="dark:bg-[#1E1E1E] bg-white border dark:border-neutral-600 border-neutral-400/60 shadow-xl relative rounded-lg sm:h-48">
            ...
            <div className="flex justify-center gap-x-2 px-2">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>
                      <span className="text-white">Follow me on Twitter</span>
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link
                      href={"https://linkedin.com/in/Joenaldo"}
                      className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                    >
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>
                      <span className="text-white">Check out my GitHub</span>
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link
                      href={"https://behance.net/Joenaldo"}
                      className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                    >
                  ...
                  <TooltipContent>
                    <p>
                      <span className="text-white">View my Behance</span>
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
